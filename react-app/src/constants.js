...
export const GAME_CONSTANTS = {
  ...
  PLAYER_STATS: {
    BASE_STATS: window.GAME_CONSTANTS?.PLAYER_STATS?.BASE_STATS || {
      GK: { speed: 60, pass: 58, shot: 40, def: 70, freeKick: 45, penalty: 55 },
      DC: { speed: 58, pass: 62, shot: 42, def: 70, cross: 40, heading: 68 },
      DR: { speed: 64, pass: 64, shot: 46, def: 64, cross: 62, heading: 58 },
      DL: { speed: 64, pass: 64, shot: 46, def: 64, cross: 62, heading: 58 },
      MC: { speed: 64, pass: 68, shot: 58, def: 60, cross: 56, heading: 56 },
      MR: { speed: 68, pass: 66, shot: 62, def: 56, cross: 70, heading: 54 },
      ML: { speed: 68, pass: 66, shot: 62, def: 56, cross: 70, heading: 54 },
      FR: { speed: 72, pass: 66, shot: 68, def: 48, cross: 62, heading: 58 },
      FL: { speed: 72, pass: 66, shot: 68, def: 48, cross: 62, heading: 58 },
      ST: { speed: 68, pass: 60, shot: 74, def: 46, cross: 50, heading: 72 },
    },
    WEIGHTS: window.GAME_CONSTANTS?.PLAYER_STATS?.WEIGHTS || {
      GK: { speed: 0.15, pass: 0.15, shot: 0.05, def: 0.35, freeKick: 0.1, penalty: 0.2 },
      DC: { speed: 0.1, pass: 0.15, shot: 0.05, def: 0.4, cross: 0.05, heading: 0.25 },
      DR: { speed: 0.2, pass: 0.2, shot: 0.05, def: 0.25, cross: 0.2, heading: 0.1 },
      DL: { speed: 0.2, pass: 0.2, shot: 0.05, def: 0.25, cross: 0.2, heading: 0.1 },
      MC: { speed: 0.15, pass: 0.3, shot: 0.15, def: 0.15, cross: 0.1, heading: 0.15 },
      MR: { speed: 0.25, pass: 0.2, shot: 0.15, def: 0.1, cross: 0.3, heading: 0.05 },
      ML: { speed: 0.25, pass: 0.2, shot: 0.15, def: 0.1, cross: 0.3, heading: 0.05 },
      FR: { speed: 0.25, pass: 0.15, shot: 0.25, def: 0.05, cross: 0.2, heading: 0.1 },
      FL: { speed: 0.25, pass: 0.15, shot: 0.25, def: 0.05, cross: 0.2, heading: 0.1 },
      ST: { speed: 0.2, pass: 0.1, shot: 0.4, def: 0.05, cross: 0.05, heading: 0.2 },
    },
  },
  STORAGE: {
